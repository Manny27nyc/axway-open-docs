...
{{< alert title="Note" >}}After upgrading your Cassandra database, follow section [Repair and upgrade your tables](#repair-and-upgrade-your-tables) to repair and upgrade your tables.{{< /alert >}}

#### Repair and upgrade your tables

After you upgrade Cassandra in each API Gateway, run the following commands to repair and upgrade your tables:
...
4. To complete your installation, perform all steps from section [Upgrade Cassandra in a multi-node single datacenter, Stage 1](#stage-1---upgrade-cassandra-2282212-to-2219).
